(() => {
  ...
  table.insertAdjacentElement("afterend", attribution);
  ...
  fetch(endpoint, { headers: { Accept: "application/json" } })
    ...
    .then(events => {
      ...
      if (upcoming.length === 0) {
        ...
        cell.textContent = "Nothing is currently scheduled. Check back soon.";
    ...
    .catch(error => {
      console.warn("ScheduleHat calendar unavailable; using recurring fallback schedule.", error);
